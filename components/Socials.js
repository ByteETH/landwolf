  ...
  return (
    <>
      <div className="socialsContainer">
        ...
        <a href='https://www.dextools.io/app/es/solana/pair-explorer/' rel='noreferrer' target="_BLANK">
        <div className="box">
          <Image src="/dx.png" width={wDx} height={hDx} alt="" />
        </div>
        </a>
        <a href='https://raydium.io/swap/?outputCurrency=' rel='noreferrer' target="_BLANK">
        <div className="box">
